...
def primitive(f_raw):
    ...
    forward_pass:
        ...
        np.linspace <--- f_wrapped (calling it trigers the f_wrapped function).
        If these np functions are used just like
        regular numpy functions they return a numpy array
    """
    @wraps(f_raw)
