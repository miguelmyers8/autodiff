...
def wrap_if_containers_inside(raw_array, slow_op_name=None):
...
class r_class():
    def __getitem__(self, args):
        ...
        return wrap_if_containers_inside(raw_array, slow_op_name = "r_")
r_ = r_class()

class c_class():
    def __getitem__(self, args):
        raw_array = _np.c_[args]
        return wrap_if_containers_inside(raw_array, slow_op_name = "c_")
c_ = c_class()
